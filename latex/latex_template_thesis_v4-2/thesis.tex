...
\begin{enumerate}
    ...
    Together, these sub-research questions can be used to answer the main question:
...
For question four, \textit{What state-of-the-art information retrieval techniques can be leveraged to develop an efficient video information retrieval system}?, a Weaviate vector database Python client has been built.
...
\begin{figure}[htbp]\caption{Visualization of WER where green represents a substitution and red a deletion.}\label{fig:whisperResultWERVis1}
    \centering
...
Some meetings already had their agenda points labeled. By using these pre-labeled agenda points as a ground truth, I tested the created topic segmentation script described in section \ref{sec:agendapoints}, thus answering research question 3.

I ran the segmentation script on 10 different meetings, using their provided agenda points as a ground truth. Next, I counted the number of missed agenda points and the number of false agenda points.
