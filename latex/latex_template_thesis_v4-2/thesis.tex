...
First, the transcript of a meeting is fed in to an LLM with the task to give the most important subjects of the meeting. 
...
\subsection{Agenda points}
As it tuned out, some meetings already had their agenda points public and labeled. I used these known agenda points to test the video segmentation script, thus answering the research question \textit{how accurately can such a video be segmented into the meaningfully different parts which are discussed}?

I ran the script on 10 different meetings, using their provided agenda points as a ground truth. Next, I counted the number of missed agenda points, the number of false agenda points and how far from the true starting point the LLM estimated the agenda points to be.
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{}
    \caption{Agenda points timing results}
    \label{fig:agendaTimeResults}
\end{figure}
