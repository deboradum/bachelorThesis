...
\begin{figure}
    \centering
    \includegraphics[width=0.98\textwidth]{images/webapp.png}
    % \caption{Video analysis pipeline}
    \label{fig:webapp}
\end{figure}
\end{frame}
...
\section{Evaluation}
% \subsection{Analysis}
\begin{frame}\frametitle{Whisper}
\end{frame}

\begin{frame}\frametitle{Pyannote.audio}
\end{frame}

% \subsection{Agenda point segmentation}
\begin{frame}\frametitle{Agenda point segmentation}
\end{frame}

% \subsection{Search engine}
\begin{frame}\frametitle{Search engine}
\end{frame}
